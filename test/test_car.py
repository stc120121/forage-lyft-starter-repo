...
from carFactory.calliope import Calliope
from carFactory.glissade import Glissade
from carFactory import Palindrome, CarFactory
...
class TestPalindrome(unittest.TestCase):
    ...
    def test_engine_should_not_be_serviced(self):
        ...
        car = CarFactory.create_palindromee(last_service_date, warning_light_is_on)
        self.assertFalse(car.needs_service())
